...
if (Core::moduleIsActive('siteuser'))
{
	...
	if(($sProviderId = Core_Array::getGet('oauth_provider')) !== NULL)
	{
		try
		{
			Siteuser_Oauth_Controller::factory(Core_Entity::factory('Siteuser_Identity_Provider', intval($sProviderId))->name)->execute();
		}
		catch (Exception $e) 
		{
			echo $e->getMessage();
