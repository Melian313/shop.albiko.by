	...
	<xsl:template match="/poll_group">
		...
		<div class="block block-side-nav last">
			<div class="block-title">
				<strong>
					<i class="fa fa-bullhorn"></i><span>Опрос</span>
				</strong>
			</div>
		...
		<div class="survey_block">
			...
			<div class="poll">
				<form action="{/poll_group/url}poll-{@id}/" method="post">
					...
					<!-- <p><i class="fa fa-bullhorn bg-color1"></i><input class="button bg-color1" type="submit" name="vote" value="Ответить"/></p>
					...
					<div class="actions">
						<button class="button btn-cart" title="vote" type="submit" name="vote" value="vote">
							<i class="fa fa-bullhorn bg-color1">
								<b></b>
							</i>
