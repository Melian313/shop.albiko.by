			...
			<div class="comment no-background">
				<form action="/users/registration/" method="post" class="form-horizontal" enctype="multipart/form-data">
					<div class="form-group">
						<label for="captcha" class="col-xs-12 col-sm-3 col-md-3 col-lg-3 control-label">Логин<sup><font color="red">*</font></sup></label>
					...
					<div class="form-group">
						<label for="captcha" class="col-xs-12 col-sm-3 col-md-3 col-lg-3 control-label">Пароль<xsl:if test="@id = 0"><sup><font color="red">*</font></sup></xsl:if></label>
						<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
							<input name="password" type="password" class="form-control" value="" size="35"/>
						</div>
					</div>
					<div class="form-group">
						<label for="captcha" class="col-xs-12 col-sm-3 col-md-3 col-lg-3 control-label">E-mail<sup><font color="red">*</font></sup></label>
						<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
							<input name="email" type="text" class="form-control" value="{email}" size="35"/>
						</div>
					</div>
					<div class="form-group">
						<label for="captcha" class="col-xs-12 col-sm-3 col-md-3 col-lg-3 control-label">Имя</label>
						<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
							<input name="name" type="text" class="form-control" value="{name}" size="35"/>
						</div>
					</div>
					<div class="form-group">
						<label for="captcha" class="col-xs-12 col-sm-3 col-md-3 col-lg-3 control-label">Фамилия</label>
						<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
					...
					<div class="form-group">
						<label for="captcha" class="col-xs-12 col-sm-3 col-md-3 col-lg-3 control-label"></label>
						<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
