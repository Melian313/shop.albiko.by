				...
				<div class="collapse navbar-collapse" id="top-menu">
					<ul class="nav navbar-nav">
						...
						<li>
							...
							<a href="/" title="{name}" hostcms:id="{@id}" hostcms:field="name" hostcms:entity="structure" data-toggle="dropdown" class="dropdown-toggle" onclick="location.href = this.href"><i class="fa fa-home"></i>
							</a>
						</li>
