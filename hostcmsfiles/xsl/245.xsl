	...
	<xsl:template match="/site">
		...
		<form method="get" action="/search/" class="search form-horizontal">
			<div class="input-group">
				<input id="search" type="text" size="50" name="text" value="{query}" maxlength="200" class="input_buttom_search form-control"/><xsl:text> </xsl:text>
			...
			<!--	<div class="col-sm-5">
					<div class="actions actions-search">
						<button class="button btn-cart" type="submit">
							<i class="fa fa-search bg-color5"></i>
							<span class="bg-color3">
								<span>Искать</span>
							</span>
						</button>
