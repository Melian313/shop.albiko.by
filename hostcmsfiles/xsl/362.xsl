				...
				<xsl:if test="forum_topic/allow_add_post = 1">
					...
					<div class="add_message_table">
						<div class="form-group">
							<!-- Заголовок темы-->
							<div class="col-xs-3 col-sm-3 col-md-3 col-sm-3 control-label">Тема:</div>
						...
						<a name="answer"/>
						<div class="form-group">
							<div class="col-xs-3 col-sm-3 col-md-3 col-sm-3 control-label"></div>
						...
						<div class="form-group">
							<label for="" class="col-xs-3 col-sm-3 col-md-3 col-sm-3 control-label"></label>
							<div class="col-xs-9 col-sm-9 col-md-9 col-sm-9">
								<div class="actions">
