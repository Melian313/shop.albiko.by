		...
		<form id="form_add_topic" action="./" method="post" class="form-horizontal validate">
			...
			<div class="add_message_table">
				<div class="form-group">
					...
					<div class="col-xs-9 col-sm-9 col-md-9 col-lg-9"><input id="topic_title" type="text" class="form-control" name="topic_subject" value="{$topic_title}"/></div>
				</div>
				...
				<xsl:if test="not(siteuser/node()) and forum_category/use_captcha = 1">
					<div class="form-group">
						<label for="captcha" class="col-xs-3 col-sm-3 col-md-3 col-lg-3 control-label">Контрольное число<sup><font color="red">*</font></sup></label>
				...
				<div class="form-group">
					...
					<div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
						<div class="actions">
							<button class="button btn-cart" type="submit" name="add_edit_topic" value="add_edit_topic">
