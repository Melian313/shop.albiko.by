...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="siteuser">
		...
		<h1 class="item_title">Мои диалоги</h1>
		...
		<div id="siteuser_messages">
			...
			<div class="actions">
				<button class="button btn-cart" onclick="$('#form_msg').toggle('fast')" type="submit">
			...
			<div id="form_msg" class="comment no-background" style="display: none;">
				<form method="post" action="{url}" class="form-horizontal">
					<div class="form-group">
						<label for="" class="col-sm-3 control-label">Получатель</label>
						<div class="col-sm-9">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="subject" size="72" class="form-control" />
						</div>
					...
					<div class="form-group">
						<label for="" class="col-sm-3 control-label">Сообщение</label>
						<div class="col-sm-9">
							<textarea name="text" rows="7" cols="54" class="form-control"></textarea>
						</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="actions">
								<button class="button btn-cart" type="submit" name="add_message" value="add_message">
									<i class="fa fa-share bg-color5"></i>
									<span class="bg-color3">
										<span>Отправить</span>
									</span>
