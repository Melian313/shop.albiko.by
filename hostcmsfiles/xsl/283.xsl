...
<xsl:stylesheet version="1.0"
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="float: right">
					<a href="{url}myPosts/">
						<div class="actions forum-button">
							<button class="button btn-cart" title="myPosts" type="submit" name="myPosts" value="myPosts">
								<i class="fa fa-envelope-o bg-color5">
									<b></b>
								</i>
							...
							<form class="form-inline" name="mainform" action="/users/" method="post">
								<div class="row">
									...
									<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
										<div class="actions forum-button">
											<button class="button btn-cart" title="Enter" type="submit" name="apply" value="apply">
												<i class="fa fa-sign-in bg-color5">
													<b></b>
												</i>
												<span class="bg-color3">
													<span>Войти</span>
							...
							<div class="comment no-background">
								<form class="form-horizontal" name="mainform1" action="/users/registration/" method="post">
									<div class="form-group">
										<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 control-label">Логин<sup><font color="red">*</font></sup></div>
										<div class="col-xs-9 col-sm-9 col-md-9 col-lg-9"><input class="form-control" type="text" size="40" value="" name="login" /></div>
									</div>
									<div class="form-group">
										<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 control-label">Пароль<sup><font color="red">*</font></sup></div>
										<div class="col-xs-9 col-sm-9 col-md-9 col-lg-9"><input class="form-control" type="password" size="40" value="" name="password"/></div>
									</div>
									<div class="form-group">
										<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 control-label">E-mail<sup><font color="red">*</font></sup></div>
										<div class="col-xs-9 col-sm-9 col-md-9 col-lg-9"><input class="form-control" type="text" size="40" value="" name="email" /></div>
									</div>


									<div class="form-group">
										<label for="captcha" class="col-xs-3 col-sm-3 col-md-3 col-sm-3 control-label">Контрольное число<sup><font color="red">*</font></sup></label>
										<div class="col-xs-3 col-sm-3 col-md-3 col-sm-3">
	...
	<xsl:template match="forum_category">
		...
		<div class="row forum">
			...
			<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 padding-top-10">
				<xsl:choose>
	...
	<xsl:template match="forum_group">
		<div class="row forum-group-title">
			...
			<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 padding-top-10">Последнее сообщение</div>
			<div class="col-xs-1 col-sm-1 col-md-1 col-lg-1 padding-top-10">Тем</div>
			<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2 padding-top-10">Сообщений</div>
		</div>
