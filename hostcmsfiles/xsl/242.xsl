...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="/informationsystem">
		...
		<div class="actions item-margin-left text-align-center">
			<button class="button btn-cart" type="button" title="Add Comment" onclick="$('#AddRecord').toggle('slow')">
				...
				<form action="./" method="post" class="form-horizontal">
					...
					<xsl:if test="/informationsystem/siteuser_id = 0">
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input class="form-control" type="text" name="author" size="50" value="{/informationsystem/adding_item/author}"/>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input class="form-control" type="text" name="email" size="50" value="{/informationsystem/adding_item/email}"/>
							</div>
						</div>
					</xsl:if>

					<div class="form-group">
						<label for="" class="col-sm-3 control-label">Тема</label>
						<div class="col-sm-9">
							<input class="form-control" type="text" name="subject" size="50" value="{/informationsystem/adding_item/subject}"/>
						</div>
					</div>

					<div class="form-group">
						<label for="" class="col-sm-3 control-label">Текст сообщения</label>
						<div class="col-sm-9">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<div class="actions">
								<button class="button btn-cart" type="submit" name="submit_question" value="submit_question">
				...
				<xsl:choose>
					...
					<xsl:otherwise>
						<xsl:choose>
							...
							<xsl:otherwise>
								<span><i class="fa fa-user"></i><xsl:value-of select="property_value[tag_name='author']/value"/></span>
							</xsl:otherwise>
						</xsl:choose>
