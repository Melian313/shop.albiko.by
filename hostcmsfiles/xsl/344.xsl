...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="helpdesk">
		...
		<h1 class="item_title">Служба поддержки <xsl:value-of disable-output-escaping="yes" select="name"/></h1>
		...
		<form method="get" action="{/helpdesk/url}" class="form-horizontal">
			<div class="form-group">
				<label for="" class="col-sm-3 control-label">Cостояние запроса</label>			
				...
				<div class="col-sm-4">
					...
					<div class="actions">
						<button class="button btn-cart" type="submit" name="apply_filter" value="apply_filter">
		...
		<div id="ShowAddTicket">
			<p>
			<i class="fa fa-plus-circle"></i><a href="#" onclick="$('#AddTicket').toggle('slow'); return false;">Написать запрос</a>
			<i class="fa fa-calendar"></i><a href="{url}worktime/">Режим работы</a>
			</p>
		</div>
