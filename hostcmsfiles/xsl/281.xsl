...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="/forum">
					...
					<xsl:otherwise>
						<a href="{url}{forum_category/@id}/addTopic/">
							<div class="actions forum-button">
								<button class="button btn-cart" type="submit" name="addTopic" value="addTopic">
		...
		<form action="{url}" method="post">
			...
			<div class="row forum-group-title height-48">
				...
				<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">Последнее сообщение</div>
			</div>
	...
	<xsl:template match="forum_topics/forum_topic">
		...
		<xsl:if test="($moderator = 1) or (visible = 1)">
				...
				<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 text-align-center">
